...
function About() {
  return (
    <div className='md:h-[700px] xl:flex items-center justify-around relative'>
      ...
      <div className='wow animate__animated animate__bounceInRight photo m-2 h-[250px] xl:h-[80%] w-[80%] sm:w-[50%] md:w-[35%] relative rounded-lg overflow-hidden' >
