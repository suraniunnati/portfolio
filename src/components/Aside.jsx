...
function Aside({toggleSidebar}) {
    return (
        <div className='border-e border-[#17191B] h-[800px] w-[250px] bg-black p-1 relative'>
            <i className="fa-solid fa-xmark absolute right-2 top-2 md:hidden"  onClick={toggleSidebar}></i>
